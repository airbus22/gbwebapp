...
<head runat="server">
    <title></title>
    <link href="/gbwebapp/CSS/Rekrutacja_KSAP.css" rel="stylesheet" type="text/css" />    
</head>
<body>
    <form id ="form1" runat="server">
        ...
        <div id="ObszarFormularza">                      
            ...
            <div id="PodobszarPrawy1">                
                ...
                <p><asp:DropDownList ID="asz_wojewodztwo_ddl" runat="server">
                    <asp:ListItem></asp:ListItem>
            ...
            <div id="PodobszarPrawy2">                
                ...
                <p><asp:TextBox ID="w1_miejscowosc_tbx" runat="server" Width="327px"></asp:TextBox></p>
                <p><asp:TextBox ID="w1_kierunekStudiow_tbx" runat="server" Width="327px"></asp:TextBox></p>
                <p><asp:DropDownList ID="w1_wyksztalcenie_ddl" runat="server">
                    <asp:ListItem></asp:ListItem>
            ...
            <asp:Panel ID="w2_Panel" runat="server" Visible="False">
                ...
                <div id="PodobszarPrawy2">                
                <p><asp:DropDownList ID="w2_uczelniaWyzsza_ddl" runat="server">
                        <asp:ListItem></asp:ListItem>
                        <asp:ListItem>Białystok - Niepaństwowa Wyższa Szkoła Pedagogiczna</asp:ListItem>
                        <asp:ListItem>Białystok - Politechnika Białostocka</asp:ListItem>
                        <asp:ListItem>Białystok - Uniwersytet Medyczny w Białymstoku</asp:ListItem>
                ...
                <p><asp:TextBox ID="w2_miejscowosc_tbx" runat="server" Width="327px"></asp:TextBox></p>
                <p><asp:TextBox ID="w2_kierunekStudiow_tbx" runat="server" Width="327px"></asp:TextBox></p>
                <p><asp:DropDownList ID="w2_wyksztalcenie_ddl" runat="server">
                    <asp:ListItem></asp:ListItem>
                    <asp:ListItem>administracyjne</asp:ListItem>   
                    <asp:ListItem>ekonomiczne</asp:ListItem> 
                    <asp:ListItem>filologiczne</asp:ListItem>
            ...
            <div id="PodobszarPrawy2">                
                <p><asp:DropDownList ID="w3_uczelniaWyzsza_ddl" runat="server">
                        <asp:ListItem></asp:ListItem>
                        <asp:ListItem>Białystok - Niepaństwowa Wyższa Szkoła Pedagogiczna</asp:ListItem>
                        <asp:ListItem>Białystok - Politechnika Białostocka</asp:ListItem>
                        <asp:ListItem>Białystok - Uniwersytet Medyczny w Białymstoku</asp:ListItem>
                ...
                <p><asp:TextBox ID="w3_miejscowosc_tbx" runat="server" Width="327px"></asp:TextBox></p>
                <p><asp:TextBox ID="w3_kierunekStudiow_tbx" runat="server" Width="327px"></asp:TextBox></p>
                <p><asp:DropDownList ID="w3_wyksztalcenie_ddl" runat="server">
                    <asp:ListItem></asp:ListItem>
                    <asp:ListItem>administracyjne</asp:ListItem>   
                    <asp:ListItem>ekonomiczne</asp:ListItem> 
                    <asp:ListItem>filologiczne</asp:ListItem>
